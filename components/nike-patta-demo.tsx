...
export default function NikePattaDemo({ onFiltersChange, isOpen, onOpenChange }: NikePattaDemoProps) {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      ...
      <SheetContent side="right" className="w-[400px] sm:w-[500px]">
        <SheetHeader>
          <SheetTitle className="text-left">STREETWEAR COLLAB - Nike x Patta</SheetTitle>
        </SheetHeader>
